    ...
    const handleSearch = (e) => {
        ...
        const filteredCountries = 
            ...
            : CountriesList.filter((country) => 
                // transfer Letters name cantry to lowercase and include on lowercase
